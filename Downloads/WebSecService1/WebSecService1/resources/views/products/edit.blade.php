                    ...
                    <form action="{{ route('products.update', $product) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="image-upload-container" id="imageUploadContainer">
                                @if($product->image)
                                    <img src="{{ asset('storage/' . $product->image) }}" alt="Current Image" class="image-preview" id="imagePreview">
                                    <div class="image-upload-placeholder d-none" id="imageUploadPlaceholder">
                            ...
                            <div class="text-center mt-2 mb-3 {{ $product->image ? '' : 'd-none' }}" id="imageActions">
                                <button type="button" class="btn btn-sm btn-outline-primary me-2" id="changeImageBtn">
                            ...
                            <small class="form-text text-muted d-block mt-2">Leave empty to keep the current image</small>
                            ...
                            document.addEventListener('DOMContentLoaded', function() {
                                ...
                                function updateImagePreview() {
                                    if (imageInput.files && imageInput.files[0]) {
                                        ...
                                        reader.onload = function(e) {
                                            ...
                                            removeImageFlag.value = '0'; // Reset remove flag when new image is selected
                                        };
                                ...
                                removeImageBtn.addEventListener('click', function() {
                                    ...
                                    removeImageFlag.value = '1'; // Set flag to remove current image
                                });
                                ...
                                form.addEventListener('submit', function() {
                                    ...
                                    console.log('Remove image flag:', removeImageFlag.value);
                                });
                            });
                            </script>
                        </div>
