...
<head>
    ...
    <title>Notifications - Instructor Dashboard</title>
...
<body class="bg-gradient-to-br from-emerald-50 via-white to-green-50 min-h-screen">
            ...
            <div class="flex justify-between h-16">
                <div class="flex items-center">
                    ...
                    <div class="hidden md:ml-6 md:flex md:space-x-8">
                        ...
                        <a href="/instructor/notifications" class="border-emerald-500 text-gray-900 inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium">
    ...
    <div class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
        ...
        <div class="gradient-bg rounded-xl shadow-xl p-8 mb-8 text-white">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-emerald-100 text-lg">Stay updated with course activities, student submissions, and important announcements</p>
                </div>
                <div class="hidden md:block">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
            <div class="instructor-card rounded-xl shadow-lg p-6 card-hover">
                <div class="flex items-center">
                    <div class="flex-shrink-0">
            ...
            <div class="instructor-card rounded-xl shadow-lg p-6 card-hover">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-bold text-gray-900" id="assignment-notifications">
                            <span class="skeleton w-8 h-6 rounded inline-block"></span>
                        </p>
                    </div>
                </div>
            ...
            <div class="instructor-card rounded-xl shadow-lg p-6 card-hover">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-bold text-gray-900" id="grading-notifications">
                            <span class="skeleton w-8 h-6 rounded inline-block"></span>
                        </p>
                    </div>
                </div>
        ...
        <!-- Controls -->
        <div class="instructor-card rounded-xl shadow-lg p-6 mb-8">
            <div class="flex flex-col md:flex-row md:items-center md:justify-between space-y-4 md:space-y-0">
                <div class="flex flex-col md:flex-row md:items-center space-y-4 md:space-y-0 md:space-x-4">
                    <select id="filter-type" class="px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-transparent">
                    ...
                    <select id="filter-priority" class="px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-transparent">
                    ...
                    <select id="filter-status" class="px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-transparent">
        ...
        <!-- Notifications List -->
        <div class="instructor-card rounded-xl shadow-lg">
            <div class="p-6">
        ...
        <div id="empty-state" class="hidden text-center py-12">
            <div class="instructor-card rounded-xl shadow-lg p-12">
    ...
    <script>
        ...
        // API call utility (same as manager)
        ...
        function updateStats() {
            ...
            const gradingCount = allNotifications.filter(n => n.type === 'grade').length;
            ...
            document.getElementById('assignment-notifications').textContent = assignmentCount;
            document.getElementById('grading-notifications').textContent = gradingCount;
        }
                                    ...
                                    <div class="flex items-center justify-between mt-3">
                                        ...
                                        <div class="flex space-x-2">
                                            ${!notification.is_read ?
                                                `<button onclick="markAsRead(${notification.id}, event)" class="text-emerald-600 hover:text-emerald-800 text-xs">
        ...
        // Helper functions (same as manager but with emerald colors)
        ...
        // Notification actions (same as manager)
