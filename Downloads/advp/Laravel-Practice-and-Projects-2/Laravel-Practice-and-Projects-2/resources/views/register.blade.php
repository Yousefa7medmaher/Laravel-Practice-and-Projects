        ...
        <div class="max-w-md mx-auto px-4 sm:px-6">
            <div class="bg-white rounded-xl shadow-xl p-8">
                ...
                <form id="register-form" class="space-y-6">
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" id="name" name="name" class="w-full pl-10 px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500" placeholder="John Doe" required>
                        </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="password" id="password_confirmation" name="password_confirmation" class="w-full pl-10 px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500" placeholder="••••••••" required>
                        </div>
                        <div id="password_confirmation-error" class="hidden text-red-500 text-sm mt-1"></div>
                    </div>
                    ...
                    <div class="flex items-center">
                        ...
                        <label for="terms" class="ml-2 block text-sm text-gray-700">I agree to the <a href="#" class="text-indigo-600 hover:text-indigo-800">Terms of Service</a> and <a href="#" class="text-indigo-600 hover:text-indigo-800">Privacy Policy</a></label>
                    </div>

                    <div id="register-error" class="hidden p-3 bg-red-50 rounded-lg text-center text-red-500"></div>
                ...
                <div class="mt-8 text-center">
                    ...
                    <a href="/login" class="mt-2 inline-block text-indigo-600 font-semibold hover:text-indigo-800 transition duration-300">Sign in to your account</a>
                </div>
            </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (registerForm) {
                registerForm.addEventListener('submit', function(e) {
                    ...
                    if (!termsAccepted) {
                        document.getElementById('register-error').textContent = 'You must accept the Terms of Service and Privacy Policy';
                    ...
                    .then(data => {
                        if (data.access_token) {
                            ...
                            setTimeout(() => {
                                // Use the redirect URL from the API response if available, otherwise default to student dashboard
