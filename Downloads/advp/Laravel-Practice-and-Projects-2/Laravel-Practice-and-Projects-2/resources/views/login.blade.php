                ...
                loginForm.addEventListener('submit', function(e) {
                    ...
                    .then(data => {
                        if (data.access_token) {
                            // Clear any existing tokens first (important for token rotation)
                            ...
                            // Store token creation timestamp for debugging
                            ...
                            setTimeout(() => {
                                ...
                                console.log('Redirect URL from API:', data.redirect_url);

                                // Always use the redirect URL from the API response
                                // The backend determines the correct URL based on role
                                if (data.redirect_url) {
                                    window.location.href = data.redirect_url;
                                } else {
                                    // Fallback redirect based on role (should not happen with updated backend)
                                    switch(data.role) {
                                        case 'manager':
