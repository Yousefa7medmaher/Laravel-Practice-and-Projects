                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-10">
                        ...
                        <div class="course-card bg-white rounded-xl shadow-md overflow-hidden">
                            <div class="h-48 bg-gray-200">
                                <img src="https://images.unsplash.com/photo-1516321318423-f06f85e504b3?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80" alt="Web Development" class="w-full h-full object-cover">
                            </div>
                            <div class="p-6">
                                <div class="flex justify-between items-start mb-2">
                                    <h3 class="text-xl font-semibold text-gray-800">Web Development Bootcamp</h3>
                                    <span class="bg-indigo-100 text-indigo-800 text-xs font-semibold px-2.5 py-0.5 rounded">CS101</span>
                                </div>
                                <p class="text-sm text-gray-500 mb-4">Instructor: John Smith</p>
                                <p class="text-gray-600 mb-4 line-clamp-3">Learn modern web development with HTML, CSS, JavaScript, React, Node.js and more. Build real-world projects and prepare for a career in tech.</p>
                                <div class="flex justify-between items-center">
                                    <span class="text-sm font-medium text-gray-600">3 Credit Hours</span>
                                    <a href="/courses" class="text-indigo-600 hover:text-indigo-800 font-medium">View Details</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="course-card bg-white rounded-xl shadow-md overflow-hidden">
                            <div class="h-48 bg-gray-200">
                                <img src="https://images.unsplash.com/photo-1526379095098-d400fd0bf935?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1074&q=80" alt="Data Science" class="w-full h-full object-cover">
                            </div>
                            <div class="p-6">
                                <div class="flex justify-between items-start mb-2">
                                    <h3 class="text-xl font-semibold text-gray-800">Data Science Fundamentals</h3>
                                    <span class="bg-indigo-100 text-indigo-800 text-xs font-semibold px-2.5 py-0.5 rounded">CS202</span>
                                </div>
                                <p class="text-sm text-gray-500 mb-4">Instructor: Sarah Johnson</p>
                                <p class="text-gray-600 mb-4 line-clamp-3">Master the essentials of data science including Python, statistics, machine learning, and data visualization. Work on real-world datasets and build your portfolio.</p>
                                <div class="flex justify-between items-center">
                                    <span class="text-sm font-medium text-gray-600">4 Credit Hours</span>
                                    <a href="/courses" class="text-indigo-600 hover:text-indigo-800 font-medium">View Details</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="course-card bg-white rounded-xl shadow-md overflow-hidden">
                            <div class="h-48 bg-gray-200">
                                <img src="https://images.unsplash.com/photo-1551434678-e076c223a692?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80" alt="Mobile App Development" class="w-full h-full object-cover">
                            </div>
                            <div class="p-6">
                                <div class="flex justify-between items-start mb-2">
                                    <h3 class="text-xl font-semibold text-gray-800">Mobile App Development</h3>
                                    <span class="bg-indigo-100 text-indigo-800 text-xs font-semibold px-2.5 py-0.5 rounded">CS303</span>
                                </div>
                                <p class="text-sm text-gray-500 mb-4">Instructor: Michael Chen</p>
                                <p class="text-gray-600 mb-4 line-clamp-3">Build cross-platform mobile applications using React Native. Learn app architecture, state management, and how to deploy to both iOS and Android platforms.</p>
                                <div class="flex justify-between items-center">
                                    <span class="text-sm font-medium text-gray-600">3 Credit Hours</span>
                                    <a href="/courses" class="text-indigo-600 hover:text-indigo-800 font-medium">View Details</a>
                                </div>
